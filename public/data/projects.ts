const projects = [
  {
    ...
    description:
      "An AI powered video caption generator powered by Deepgram AI video transcription API. Built with NextJS,Tailwind CSS, FFmpeg and Firebase Cloud Storage.",
    technologies: ["Next.js", "Tailwind CSS", "Firebase", "Tailwind CSS", "Deepgram API"],
    imageUrl: "/portofolio/images/project1.png",
  ...
  },
  {
    ...
    description:
      "A movies and TV shows aggregate website that allows users to browse, search, and filter a vast library of movies and TV shows. Built with Angular v17, TMDB API, and design based on Netflix.",
    technologies: ["Angular", "Typescript", "SCSS", "TMDB API"],
    imageUrl: "/portofolio/images/project2.png",
  ...
  },
  {
    ...
    description:
      "A password manager application that enables users to generate, store, and manage their passwords, developed as my final project for Harvard's CS50 course.",
    technologies: ["HTML", "CSS", "JavaScript", "jQuery", "Python", "Flask", "SQL"],
    imageUrl: "/portofolio/images/project5.png",
  ...
  },
  {
    ...
    imageUrl: "/portofolio/images/project3.png",
  ...
  },
  {
    ...
    imageUrl: "/portofolio/images/project4.png",
  ...
  },
  {
    ...
    imageUrl: "/portofolio/images/project6.png",
