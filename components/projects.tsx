          ...
          >
            ...
            >
              ...
              <div className="text-lg flex gap-4">
                <a href={project.githubUrl} className="flex items-center gap-2 hover:text-textGreen relative group">
                ...
                <a href={project.projectUrl} className="flex items-center gap-2 hover:text-textGreen relative group">
                  <span className="flex items-center">
                    <LuExternalLink />
                  </span>
